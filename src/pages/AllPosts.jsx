        ...
        <div className="w-full max-w-4xl mx-auto mt-48">
          <div className="flex flex-wrap">
            <div className="w-full">
              <h2 className="text-2xl md:text-3xl font-bold font-sans text-center mb-8 text-[#76ABAE]">All Posts</h2>
              <h1 className="text-2xl md:text-3xl font-bold font-sans  mb-4">
                {authStatus ? "No posts to display" : "Login to read posts"}
              </h1>
              {authStatus && (
